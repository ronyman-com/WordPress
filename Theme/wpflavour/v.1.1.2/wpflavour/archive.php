...
<h1>
<?php if ( is_day() ) : ?>
<?php printf( __( 'Daily Archives: %s', 'wpflavour' ), '<span>' . get_the_date() . '</span>' ); ?>
<?php elseif ( is_month() ) : ?>
<?php printf( __( 'Monthly Archives: %s', 'wpflavour' ), '<span>' . get_the_date( 'F Y' ) . '</span>' ); ?>
<?php elseif ( is_year() ) : ?>
<?php printf( __( 'Yearly Archives: %s', 'wpflavour' ), '<span>' . get_the_date( 'Y' ) . '</span>' ); ?>
<?php else : ?>
<?php _e( 'Blog Archives', 'wpflavour' ); ?>
<?php endif; ?>
</h1>
