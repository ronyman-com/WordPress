...
<div class="html_content"><p><a href="<?php echo get_permalink( get_page_by_path('privacy') );?>" target="_blank" class="tt_link" target="_blank"><span style="color:rgba(255,255,255,1);">Privacy</span></a><span style="color:rgba(255,255,255,1);"> | </span><a href="<?php echo get_permalink( get_page_by_path('terms') );?>" target="_blank" class="tt_link" target="_blank"><span style="color:rgba(255,255,255,1);">Terms</span></a></p></div>
</div>
