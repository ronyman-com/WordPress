...
contentDiv = jQuery("#wpfl_content");
contentMarginDiv = jQuery("#wpfl_content_margin");
sidebar1Div = jQuery("#wpfl_sidebar_left");
sidebar2Div = jQuery("#wpfl_sidebar_right");
sidebar1MarginDiv = jQuery("#wpfl_sidebar_left_margin");
sidebar2MarginDiv = jQuery("#wpfl_sidebar_right_margin");
