...
class TemplateToaster_Theme_Options extends TemplateToaster_Theme_Options_Dynamic
{
    ...
    public function __construct()
    {
        ...
        $this->sections['error'] = __('Error Page', "wpflavour");
        $this->sections['maintenance'] = __('Maintenance', "wpflavour");
        $this->sections['shortcodes'] = __('Shortcode', "wpflavour");
        $this->sections['googlemap'] = __('GoogleMap', "wpflavour");
        //$this->sections['contactus'] = __('Contact Us', "wpflavour");
		// $this->sections['seo'] = __('SEO', "wpflavour");
        $this->sections['backuppage'] = __('Backup/Recovery', "wpflavour");
        $this->sections['export_import'] = __('Export/Import Theme Options', "wpflavour");
        $fileName = get_template_directory() . '/content/imports.php';
		if ( file_exists( $fileName ) ) { 
        $this->sections['import_content'] = __('Import Content', "wpflavour"); 
        }
    ...
    public function create_setting($args = array())
    {
        ...
        $defaults = array(
            'id' => 'default_field',
            'title' => __('Default Field', "wpflavour"),
            'desc' => __('This is a default description.', "wpflavour"),
            'std' => '',
            'type' => 'text',
            'section' => 'general',
            'choices' => array(),
    ...
    public function display_page()
    {
       ...
       //display URl error message 
        ...
        {
            echo '<div class="updated fade"><p>' . __('Theme options updated.', "wpflavour") . '</p></div>';
		}
        echo '<div id="admin_container" class="wrap">
	            <div class="icon-option"> </div>
	            <h1>' . __('Theme Options For', "wpflavour") . '&nbsp;' . $themename . '</h1><br/>';
		...
		echo '</div>';
		echo '<p class="submit">' .
            get_submit_button(__('Save Options', "wpflavour"), 'button-primary', 'ttr_submit', false). '</p>';			
		echo '</form>';
        echo '</div>';
    }
       ...
       <div id="content">
                ...
                ?>
                    <table class="table">
                        <tbody>
                        <tr>
                            <td colspan="3"><?php echo(__("To use CONTACT FORM, apply shortcode [contact_us_form]","wpflavour"));?></td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Admin Email Address',"wpflavour"));?></td>
                            <td colspan="2">
                        ...
                        <!-- Google Captcha -->
                        <tr>
                            <td><?php echo(__('Public Key For Google Captcha',"wpflavour"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Private Key For Google Captcha',"wpflavour"));?></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td><?php echo(__('Error Message',"wpflavour"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_error_message" <?php if($value_contact[3]['ttr_contact_us_error_message']){ ?> value="<?php print_r($value_contact[3]['ttr_contact_us_error_message']); ?>" <?php } else {?> value="<?php echo(__("Message was not sent. Try Again.","wpflavour"));?>"<?php } ?> name="ttr_contact_us_error_message" />
                        ...
                        <tr>
                            <td><?php echo(__('Success Message',"wpflavour"));?></td>
                            <td colspan="2">
                                <input type="textarea" id="ttr_contact_us_success_message" <?php if($value_contact[4]['ttr_contact_us_success_message']){ ?> value="<?php print_r($value_contact[4]['ttr_contact_us_success_message']); ?>" <?php } else {?> value="<?php echo(__("Thanks! Your message has been sent.","wpflavour")); ?>"<?php } ?>  name="ttr_contact_us_success_message" />

                            </td>

                        </tr>
                        <tr>
                            <td><?php echo(__('Field Name:',"wpflavour"));?></td>
                           <!-- <td><?php echo(__('Field Type:',"wpflavour"));?></td>-->
                            <td><?php echo(__('Required',"wpflavour"));?></td>
                            <td><?php echo(__('Remove',"wpflavour"));?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4"><input type="button" value="<?php echo(__('Add New Field',"wpflavour"));?>" class="newfield button-secondary" /></td>
                        </tr>
...
<?php
  ...
  /*  public function display_seoenable_section()
    ...
    public function display_backuppage_section()
    {
        ...
        $this->sections['backupsettings'] = __('Settings', "wpflavour");
        $this->sections['backup'] = __('Backup', "wpflavour");
        $this->sections['restore'] = __('Restore', "wpflavour");
	...
	?>
		<table class="form-table">
	    	<tbody>
	    		<tr>
		            <th>
		            <label><?php echo(__('Export theme options','wpflavour'));?></label>
					</th><td>	            
	            	<input id="export_yes" class="button button-primary" type="button" name="exportt" value="<?php echo(__('Export Theme Option','wpflavour'));?>" />	            	
	                </td>
	            </tr>
	            <tr>
	               <th>	               
	                <label id="select_file"><?php echo(__('Import theme options? ','wpflavour'));?></label>
	                </th><td>
			       	<input type="file" name="importfile" id="importfile" style="height:auto;">
			       	<input id="import_options_yes" class="button button-primary" type="button" value="<?php echo(__('Import Theme Options','wpflavour'));?>" name="import_options">			       
	                </td>
	            </tr>
			</tbody>
	    </table>
       ...
       if (!get_option('TemplateToaster_theme_options'))
        ...
        switch ($type) {
            ...
            case 'media':
                ...
                echo '&nbsp;<input type="button" class="ttrbutton btn" value="' . __('Upload', "wpflavour") . '"/>';
                if ($desc != '')
                    echo '<br /><span class="description">' . $desc . '</span>';
    ...
    public function get_static_options()
    {
       ...
       /* Error page Settings
        ...
        $this->settings['ttr_error_message_heading'] = array(
            'title' => __('Heading For Error Message', "wpflavour"),
            'desc' => __('Change Text For Error Message', "wpflavour"),
            'std' => __('This is somewhat embarrassing, isn&rsquo;t it?', "wpflavour"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message_content'] = array(
            'title' => __('Content For Error Message', "wpflavour"),
            'desc' => __('Change text For Error Message', "wpflavour"),
            'std' => __('It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching, or one of the links below, can help.', "wpflavour"),
            'type' => 'textarea',
            'section' => 'error'
        );
        $this->settings['ttr_error_message'] = array(
            'title' => __('Enable Content', "wpflavour"),
            'desc' => __('Hide/Show Error Message Text', "wpflavour"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_search_box'] = array(
            'title' => __('Enable Search', "wpflavour"),
            'desc' => __('Hide/Show Search Box', "wpflavour"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image'] = array(
            'title' => __('Content Image', "wpflavour"),
            'desc' => __('Choose Error Image', "wpflavour"),
            'std' => '',
            'type' => 'media',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_enable'] = array(
            'title' => __('Enable Image In Content', "wpflavour"),
            'desc' => __('Hide/Show error image', "wpflavour"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        $this->settings['ttr_error_image_height'] = array(
            'title' => __('Content Image Height', "wpflavour"),
            'desc' => __('Height Of The Error Image', "wpflavour"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_image_width'] = array(
            'title' => __('Content Image Width', "wpflavour"),
            'desc' => __('Width of The Error Image', "wpflavour"),
            'std' => '',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'error'
        ...
        $this->settings['ttr_error_home_redirect'] = array(
            'title' => __('Redirect To Home Page(If Error Page Occurs)', "wpflavour"),
            'desc' => __('Redirect to Home Page While Error Occur', "wpflavour"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'error'
        );
        ...
        $this->settings['ttr_mm_enable'] = array(
            'title' => __('Enable Maintenance Mode', "wpflavour"),
            'desc' => __('Enable/Disable Maintenance Mode', "wpflavour"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_title'] = array(
            'title' => __('Title for Maintenance Mode Page', "wpflavour"),
            'desc' => __('Set the Title', "wpflavour"),
            'std' => '',
            'type' => 'text',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_content'] = array(
            'title' => __('Content for Maintenance Mode Page', "wpflavour"),
            'desc' => __('Content for Maintenance Mode page', "wpflavour"),
            'std' => '',
            'type' => 'textarea',
            'section' => 'maintenance'
        );
        $this->settings['ttr_mm_image'] = array(
            'title' => __('Background Image for Maintenance Mode', "wpflavour"),
            'desc' => __('Select Image for Maintenance Mode Page', "wpflavour"),
            'std' => '',
            'type' => 'media',
            'section' => 'maintenance'
        );
        ...
        $this->settings['ttr_googlemap_type'] = array(
            'title' => __('Choose the type of Google Map', "wpflavour"),
            'desc' => __('Choose the type of Google Map', "wpflavour"),
            'type' => 'select',
            'std' => 'Road',
            'choices' => array(
                'choice1' => __('ROAD', "wpflavour"),
                'choice2' => __('SATELLITE', "wpflavour"),
                'choice3' => __('HYBRID', "wpflavour"),
                'choice4' => __('TERRAIN', "wpflavour")),
            'section' => 'googlemap'
        );
       $this->settings['ttr_map_latitude'] = array(
            'title' => __('Set Latitude', "wpflavour"),
            'desc' => __('Set Latitude', "wpflavour"),
            'std' => '25.306944',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_longitude'] = array(
            'title' => __('Set Longitude', "wpflavour"),
            'desc' => __('Set Longitude', "wpflavour"),
            'std' => '-257.858333',
            'pattern' => '',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_width'] = array(
            'title' => __('Set Width of Map', "wpflavour"),
            'desc' => __('Set Width of Map', "wpflavour"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_map_height'] = array(
            'title' => __('Set Height of Map', "wpflavour"),
            'desc' => __('Set Height of Map', "wpflavour"),
            'std' => '400',
            'pattern' => '\d+',
            'type' => 'text',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_marker_enable'] = array(
            'title' => __('Display Marker', "wpflavour"),
            'desc' => __('Enable/Disable the Position Marker', "wpflavour"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'googlemap'
        );
        $this->settings['ttr_marker_text'] = array(
            'title' => __('Set Marker Label', "wpflavour"),
            'desc' => __('Set Marker Label', "wpflavour"),
        ...
        $this->settings['ttr_googlemap_api'] = array(
            'title' => __('Set Google API Key', "wpflavour"),
            'desc' => __('Set Google API Key', "wpflavour"),
            'std' => '',
            'type' => 'text',
            'patter' => '\d+',
            'section' => 'googlemap'
        ...
        $this->settings['ttr_google_docs_viewer_shortcode'] = array(
            'title' => __('Google Docs Viewer', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_displaying_recent_posts_shortcode'] = array(
            'title' => __('Displaying Related Posts', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
            'std' => '[related_posts]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_google_adsense_shortcode'] = array(
            'title' => __('Google AdSense', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_google_chart_shortcode'] = array(
            'title' => __('Google Chart', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_tweet_me_button_shortcode'] = array(
            'title' => __('Tweet Me Button', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
            'std' => '[tweet]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_private_content_shortcode'] = array(
            'title' => __('Private Content', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
        ...
        /*$this->settings['ttr_contact_us_form_shortcode'] = array(
            'title' => __('Contact Us Form', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
            'std' => '[contact_us_form]',
            'section' => 'shortcodes'
        ...
        $this->settings['ttr_custommenu_shortcode'] = array(
            'title' => __('Custom Menu', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_comments_shortcode'] = array(
            'title' => __('Recent Comments', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
        ...
        $this->settings['ttr_recent_posts_shortcode'] = array(
            'title' => __('Recent Posts', "wpflavour"),
            'desc' => __('To use Copy/Paste the above shortcode', "wpflavour"),
            'type' => 'shortcode',
       ...
       ===========================================*/
        ...
        $this->settings['ttr_ftp_server_address'] = array(
            'title' => __('FTP Server Address', "wpflavour"),
            'desc' => __('Enter the FTP Address ', "wpflavour"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_name'] = array(
            'title' => __('FTP User name', "wpflavour"),
            'desc' => __('Enter the FTP username ', "wpflavour"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_user_password'] = array(
            'title' => __('FTP User password', "wpflavour"),
            'desc' => __('Enter the FTP password ', "wpflavour"),
            'std' => '',
            'type' => 'password',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_recipient_email'] = array(
            'title' => __('Email of recipient', "wpflavour"),
            'desc' => __('Enter the name of email recipient ', "wpflavour"),
            'std' => '',
            'type' => 'text',
            'section' => 'backupsettings'
        );
        $this->settings['ttr_ftp_check_connection'] = array(
            'title' => __('Check FTP Connection', "wpflavour"),
            'desc' => __('Click to check the FTP Connection Status', "wpflavour"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_manual_database_backup'] = array(
            'title' => __('Database Backup (.sql file)', "wpflavour"),
            'desc' => __('Add/Remove database (.sql) file to Backup zip', "wpflavour"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_recovery_enable'] = array(
            'title' => __('Enable Automatic Backup/Recovery Mode)', "wpflavour"),
            'desc' => __('Enable/Disable Automatic Backup/Recovery Mode', "wpflavour"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_plugin_backup'] = array(
            'title' => __('Include Plugins', "wpflavour"),
            'desc' => __('Include/Exclude plugins to Backup Zip', "wpflavour"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_theme_backup'] = array(
            'title' => __('Include Themes', "wpflavour"),
            'desc' => __('Include/Exclude themes to Backup Zip', "wpflavour"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_include_uploads_backup'] = array(
            'title' => __('Include Uploads', "wpflavour"),
            'desc' => __('Include/Exclude uploads to Backup Zip', "wpflavour"),
            'std' => 1,
            'type' => 'checkbox',
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "wpflavour"),
            'desc' => __('Set the folder name to take the backup', "wpflavour"),
            'std' => 'Backup',
            'type' => 'text',
            'section' => 'backup'
        );
        $this->settings['ttr_automatic_backup_interval'] = array(
            'title' => __('Automatic Backup intervals', "wpflavour"),
            'desc' => __('Select the database interval to take backup', "wpflavour"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('Every 10 mins', "wpflavour"),
                'choice2' => __('Every hour', "wpflavour"),
                'choice3' => __('Every 4 hours', "wpflavour"),
                'choice4' => __('Every 8 hours', "wpflavour"),
                'choice2' => __('Every 12 hours', "wpflavour"),
                'choice3' => __('Daily', "wpflavour"),
                'choice4' => __('Weekly', "wpflavour")),
            'section' => 'backup'
        );
        $this->settings['ttr_storage_backup'] = array(
            'title' => __('Choose your Remote Storage', "wpflavour"),
            'desc' => __('Set time to the backup', "wpflavour"),
            'type' => 'select',
            'std' => '-Select-',
            'choices' => array(
                'choice1' => __('FTP', "wpflavour"),
                'choice2' => __('Email', "wpflavour")),
            'section' => 'backup'
        );
        $this->settings['ttr_backup_folder_name'] = array(
            'title' => __('Backup Folder Name', "wpflavour"),
       ...
       ===========================================*/
        ...
        $this->settings['ttr_browse'] = array(
            'title' => __('Select Backup Folder', "wpflavour"),
            'desc' => __('Select the folder(.zip file only)', "wpflavour"),
            'std' => '',
            'type' => 'file',
            'section' => 'restore'
        );
        $this->settings['ttr_include_database_restore'] = array(
            'title' => __('Restore Database(.sql)', "wpflavour"),
            'desc' => __('Enable/Disable to restore databases for Site', "wpflavour"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_theme_restore'] = array(
            'title' => __('Restore Themes', "wpflavour"),
            'desc' => __('Enable/Disable to restore theme folder for Site', "wpflavour"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_plugins_restore'] = array(
            'title' => __('Restore Plugins', "wpflavour"),
            'desc' => __('Enable/Disable to restore plugins folder for Site', "wpflavour"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
        $this->settings['ttr_include_uploads_restore'] = array(
            'title' => __('Restore Uploads', "wpflavour"),
            'desc' => __('Enable/Disable to restore uploads folder for Site', "wpflavour"),
            'std' => 0,
            'type' => 'checkbox',
            'section' => 'restore'
        );
    ...
    public function scripts()
    {
        ...
        $translations = array_merge(array('tt_xmlerror' => (__('Please, select an xml file','wpflavour')), 'tt_savechanges' => (__('No changes to export in Theme Options. Please save your changes properly.','wpflavour'))));
    ...
    public function validate_settings($input)
    {
        ...
        foreach ($this->settings as  $key => $value)
        {
 			if($key == 'ttr_designedby_link_url')
            {
               ...
               { 
                 add_settings_error('templatetoaster_theme_options','errorMsg',__("Please enter a valid URL", "wpflavour"),'error') ;
			     return $options;
              }             
            }
